...
import frc.robot.commands.AutoMove_Shoot;
...
public class OI {
	...
	public static final int BUTTON_TEST_AUTO = XBox360Controller.Button.B.Number();
	...
	public OI() {
		...
		JoystickButton auto_move_tester = new JoystickButton(driverController, BUTTON_TEST_AUTO);
        auto_move_tester.whenPressed(new AutoMove_Shoot());
